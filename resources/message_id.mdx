...
Below you can see how to enable Developer Mode on bolth Desktop and Mobile.
<Tabs>
  <Tab title="Desktop">
    <Card title="An image showing how to enable Developer Mode on Desktop" img="/images/desktop.png">
      Tap on the settings, go to "Advanced", and toggle on "Developer Mode".
    </Card>
  </Tab>
  <Tab title="Mobile">
    <Card title="An image showing how to enable Developer Mode on Mobile" img="/images/mobile.png">
