...
/giveaway start 7d 1w Month of Nitro
/giveaway start 12h5m 1w Month of Nitro
```

```javascript Incorrect Syntax
/giveaway start 7 days 1w Month of Nitro
/giveaway start 12hours 5 minutes 1w Month of Nitro
```
</CodeGroup>