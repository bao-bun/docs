...
<CodeGroup>
```javascript syntax
/content view-content <content_name>
````
...
<CodeGroup>
```javascript syntax
/content create-content <content_name> <content_type>
```
</CodeGroup>
...
<CodeGroup>
```javascript syntax
/content remove-content <content_name>
```
</CodeGroup>
...
<CodeGroup>
```javascript syntax
/content set-message <content_name> [message]
```
</CodeGroup>
...
<CodeGroup>
```javascript syntax
/content set-embed <content_name>
```
</CodeGroup>
