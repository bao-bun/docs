...
<CodeGroup>
  ```syntax /welcomer add [channel] [content_name] [delay] [delete_after] [enable] [webhook_name]````
</CodeGroup>
...
<CodeGroup>``` syntax /welcomer remove [channel] ```</CodeGroup>
...
<CodeGroup>``` syntax /welcomer enable [channel] ```</CodeGroup>
...
<CodeGroup>``` syntax /welcomer test ```</CodeGroup>
