...
<CodeGroup>
  ```javascript syntax /welcomer add [channel] [content_name] [delay]
  [delete_after] [enable] [webhook_name] ```
</CodeGroup>
...
<CodeGroup>```javascript syntax /welcomer remove [channel] ```</CodeGroup>
...
<CodeGroup>```javascript syntax /welcomer enable [channel] ```</CodeGroup>
...
<CodeGroup>```javascript syntax /welcomer test ```</CodeGroup>
