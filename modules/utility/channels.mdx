...
<CodeGroup>```javascript syntax /purge [amount] [before] [after] ```</CodeGroup>
...
<CodeGroup>```javascript syntax /lock [channel] ```</CodeGroup>
...
<CodeGroup>```javascript syntax /hide [channel] ```</CodeGroup>
...
<CodeGroup>```javascript syntax /delete [channel] ```</CodeGroup>
...
<CodeGroup>```javascript syntax /nuke [channel] [delete_after] ```</CodeGroup>
...
<CodeGroup>```javascript syntax /clone [channel] ```</CodeGroup>
...
<CodeGroup>```javascript syntax /movech [category] [channel] ```</CodeGroup>
