---
title: "Custom Contents tutorial"
icon: "hashtag"
...
- `content_type` defines how the content behaves
  Examples include `message`, `embed`, or other supported types
...
<CodeGroup>
```javascript syntax
/content set-type <content_name> <content_type>
```
</CodeGroup>
...
- Use `/content view-content` to preview output
